...
import '../widgets/criminal_widget.dart';

class CriminalLawScreen extends StatefulWidget {
  const CriminalLawScreen({Key? key}) : super(key: key);

  @override
  State<CriminalLawScreen> createState() => _CriminalLawScreenState();
}
